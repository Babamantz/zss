...
<div class="container-fluid">
                        ...
                        <tr>
                            ...
                            <th style="font-size:11px;padding:11px 16px;">
                                <button class="btn p-0 border-0 fw-semibold text-muted
                                    d-flex align-items-center gap-1" style="font-size:11px;text-transform:uppercase;
                                           letter-spacing:.05em;" wire:click="sortBy('first_name')">
                                    User
                                    <i class="fa fa-sort{{
    ...
    : ''
                            ...
                            <th style="font-size:11px;padding:11px 16px;">
                                <button class="btn p-0 border-0 fw-semibold text-muted
                                    d-flex align-items-center gap-1" style="font-size:11px;text-transform:uppercase;
                                           letter-spacing:.05em;" wire:click="sortBy('email')">
                                    Email
                                    <i class="fa fa-sort{{
    $sortField === 'email'
    ? ($sortDir === 'asc' ? '-up' : '-down')
                                                ...
                                                <td style="padding:11px 16px;">
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="rounded-circle bg-primary-subtle
                                                                ...
                                                                flex-shrink-0" style="width:34px;height:34px;font-size:11px;
                                                        ...
                                                        <div class="d-flex flex-wrap gap-1">
                                                            @foreach ($perms->take(2) as $perm)
                                                                <span class="badge bg-warning-subtle
                                                                                text-warning" style="font-size:9px;">
                                                                    {{ $perm }}
                                                                </span>
                                                            @endforeach
                                                            @if ($perms->count() > 2)
