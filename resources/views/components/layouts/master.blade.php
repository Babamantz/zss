...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <!-- Font Awesome-->
    @includeIf('components.layouts.partials.css')
...
<body>
    ...
    <div class="page-wrapper compact-sidebar" id="pageWrapper">
        <!-- Page Header Start-->
        @includeIf('components.layouts.partials.header')
        <!-- Page Header Ends -->
        <!-- Page Body Start-->
        <div class="page-body-wrapper sidebar-icon">
            <!-- Page Sidebar Start-->
            @includeIf('components.layouts.partials.sidebar')
            <!-- Page Sidebar Ends-->
            <div class="page-body">
    ...
    <!-- latest jquery-->
    @includeIf('components.layouts.partials.js')
    {!! ToastMagic::scripts() !!}
</body>
