...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <button wire:click="downloadReport" wire:loading.attr="disabled" class="btn btn-success btn-sm">
    ...
    <div class="card border-0 shadow-sm mb-3">
        <div class="card-body py-2">
            <div class="row g-2 align-items-center">
                ...
                {{-- Gender --}}
                <div class="col-md-2">
                    <select wire:model.live="filterGender" class="form-select form-select-sm">
                ...
                <div class="col-md-2">
                    <select wire:model.live="filterDivision" class="form-select form-select-sm">
                ...
                <div class="d-flex flex-wrap gap-1 mt-2">
                    ...
                    @if ($filterDept)
                        <span class="badge bg-warning-subtle text-warning">
                            ...
                            <a href="javascript:void(0)" wire:click="$set('filterDept', '')"
                    ...
                    @if ($filterDivision)
                        <span class="badge bg-dark-subtle text-dark">
                            ...
                            <a href="javascript:void(0)" wire:click="$set('filterDivision', '')"
                ...
                <table class="table table-hover mb-0">
                    <thead class="table-light">
                        <tr>
                            ...
                            {{-- Name --}}
                            <th>
                                <button class="sort-btn d-flex align-items-center gap-1" wire:click="sortBy('id')">
                                    Name
                            ...
                            {{-- Gender --}}
                            <th>
                                <button class="sort-btn d-flex align-items-center gap-1" wire:click="sortBy('gender')">
                                    Gender
                                    <span class="text-muted" style="font-size:10px;">
                                        @if ($sortField === 'gender')
                                            <i class="fa fa-sort-{{ $sortDir === 'asc' ? 'up' : 'down' }}"></i>
                    ...
                    <tbody>
                        @forelse ($employees as $emp)
                            ...
                            : 'fa-person-dress' }} fa-xs me-1"></i>
                                                ...
                                                {{-- Status --}}
                                                <td>
                                                    <span class="badge {{ $emp->user?->is_active === true
                            ? 'bg-success-subtle text-success'
                            : 'bg-secondary-subtle text-secondary' }}">
                                                        {{ $emp->user?->is_active === true ? 'Active' : 'Inactive' }}
                                                    </span>
                                                </td>
