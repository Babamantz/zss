                ...
                <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            @foreach ([1 => 'Basic Info', 2 => 'Employment', 3 => 'IDs', 4 => 'Certificates', 5 => 'Education'] as $step => $label)
                                <div class="text-center {{ $currentStep >= $step ? 'text-primary' : 'text-muted' }}">
                                    <div class="mb-2">
                                        <span
                                            class="badge {{ $currentStep >= $step ? 'bg-primary' : 'bg-secondary' }} rounded-circle p-3">
                                            {{ $step }}
                                        </span>
                                    </div>
                                    <small>{{ $label }}</small>
                    ...
                    <form wire:submit.prevent="submitForm">
                                    ...
                                    <div  class="form-group">
                                        ...
                                        <select id="select-user" class="js-example-basic-single form-control" disabled>
                                            ...
                                            @foreach ($emails ?? [] as $id => $emailText)
                                                <option value="{{ $id }}" {{ (string) $userId === (string) $id ? 'selected' : '' }}>
                                                    {{ $emailText }}
                                                </option>
                                            @endforeach
                                        </select>
                                        <small class="text-muted">Email cannot be changed once an employee record
                                            exists.</small>
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div @if($currentStep != 2) style="display:none;" @endif>
                            ...
                            {{-- Department (readonly, auto-filled — matches Create) + Unit + Division --}}
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                        ...
                        {{-- ══════════════════════════════════════════════════════
                             ...
                             Server-rendered repeater (matches Create's Option A):
                             each row is a real Blade @foreach iteration, so
                             <livewire:async-select> gets its own component
                             instance per row, keyed on the row's index. No Alpine
                             x-for / @entangle here — every add/remove/edit is a
                             normal Livewire round trip.
                        ══════════════════════════════════════════════════════ --}}
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        wire:model.defer="identification_items.{{ $index }}.identification_no" {{ $disabledAttr }}>
                        ...
                        {{-- ══════════════════════════════════════════════════════
                             ...
                             Same server-rendered pattern as Step 3.
                        ══════════════════════════════════════════════════════ --}}
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        wire:model.defer="certificate_items.{{ $index }}.certificate_no" {{ $disabledAttr }}>
